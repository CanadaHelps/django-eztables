...
class BrowserFactory(factory.django.DjangoModelFactory):
	...
	engine = factory.SubFactory('eztables.tests.EngineFactory')
...
class SpecialCaseFactory(factory.django.DjangoModelFactory):
...
@override_settings(ROOT_URLCONF='eztables.test_array_urls')
...
@override_settings(ROOT_URLCONF='eztables.test_object_urls')
